...
public class ListaConsejos {
	...
	public ListaConsejos() {
		...
		consejos.add(new consejosSalud("Consejos para pasear durante climas cálidos", "Si vives en un lugar en donde ya comienza a subir la temperatura, \r\n"
				...
				+ "				Si ves que no lo hace, puedes llevar un bowl que conozco e incluso tomar una botella con el agua que tienes en casa. Puedes hacer uso de una sombrilla.", "perro comiendo"));
		consejos.add(new consejosSalud("Prevenir accidentes en el hogar", "Muchos de los accidentes que nuestros perros o gatos pueden llegar a sufrir suceden en el hogar ya sea por descuido o falta de conocimiento, pero si estamos preparados para afrontarlos, la mayor parte de las veces no será grave.\r\n"
				...
				+ "					Por esto, lo mejor es dejar desconectados todos aquellos aparatos que estén a la vista si no se están utilizando o cubrirlos con algún material que les dificulte el acceso. Recordemos que si llevamos un animal a nuestro hogar es porque estamos conscientes de que podemos garantizar su bienestar, así como un espacio seguro para que se desarrolle.", "dos perros encima de una mesa"));
		consejos.add(new consejosSalud("Consejos para cuidar a un gato de edad avanzada", "Los gatos pueden tener una vida muy larga, usualmente son capaces de vivir más que otras mascotas, con un promedio alrededor de 12 a 18 años, si bien cada animal tiene un desarrollo distintos, al llegar alrededor de los 13 años se considera que estos necesitan cuidados geriátricos. \r\n"
