...
public class ListaConsejo {
	...
	/**
	 * Crea una lista de la clase ConsejoSalud
	 */
	private List<ConsejoSalud> consejos; 
	
	/**
	 * Encapsula los datos para crear una lista de articulos
	 */
	public ListaConsejo() {
		...
		consejos.add(new ConsejoSalud(2L, "Prevenir accidentes en el hogar", "Muchos de los accidentes que nuestros perros o gatos pueden llegar a sufrir suceden en el hogar ya sea por descuido o falta de conocimiento, pero si estamos preparados para afrontarlos, la mayor parte de las veces no será grave.\r\n"
		...
		consejos.add(new ConsejoSalud(3L, "Consejos para cuidar a un gato de edad avanzada", "Los gatos pueden tener una vida muy larga, usualmente son capaces de vivir más que otras mascotas, con un promedio alrededor de 12 a 18 años, si bien cada animal tiene un desarrollo distintos, al llegar alrededor de los 13 años se considera que estos necesitan cuidados geriátricos. \r\n"
	...
	/**
	 * Metodo para agregar un nuevo articulo a la lista
	 * @return consejos Agrega un nuevo articulo a la lista
	 */
